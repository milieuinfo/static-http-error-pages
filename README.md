...
![GitHub issues](https://img.shields.io/github/issues-raw/milieuinfo/static-http-error-pages) ![GitHub pull requests](https://img.shields.io/github/issues-pr-raw/milieuinfo/static-http-error-pages) ![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/milieuinfo/static-http-error-pages)

Generieke HTTP error foutmelding pagina's voor Departement Omgeving.


## Demo
Lokaal opstarten kan met onderstaand [NPM](https://www.npmjs.com) script.
``` bash
$ npm run start
```
